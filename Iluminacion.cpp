...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
      ...
      //  model = glm::translate(model, glm::vec3(-2.0f, 0.0f, 0.0f));
       ...
       // glUniform3f(glGetUniformLocation(lightingShader.Program, "light.ambient"), 0.5f, 0.5f, 0.5f);
       // glUniform3f(glGetUniformLocation(lightingShader.Program, "light.diffuse"), 0.5f, 0.5f, 0.5f);
       //// glUniform3f(glGetUniformLocation(lightingShader.Program, "light.specular"), 49.0f, 28.0f, 1.0f);
       //
       //glUniform3f(glGetUniformLocation(lightingShader.Program, "material.ambient"), 0.1f, 0.1f, 0.1f);
       //glUniform3f(glGetUniformLocation(lightingShader.Program, "material.diffuse"), 0.0f, 0.46f, 1.0f);
       // glUniform3f(glGetUniformLocation(lightingShader.Program, "material.specular"), 0.49f, 0.28f, 1.0f);
       ...
       // centro.Draw(lightingShader);
        ...
        ////glUniform3f(glGetUniformLocation(lightingShader.Program, "material.specular"), 0.89f, 0.7f, 0.32f);

...
int main() {
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		model = glm::translate(modelTemp, glm::vec3(1.5f, 0.0f, 0.0f)); //pivote 3
		model = glm::rotate(model, glm::radians(codo), glm::vec3(0.0f, 1.0, 0.0f));//Codo
		modelTemp = model = glm::translate(model, glm::vec3(1.0f, 0.0f, 0.0f)); //´pivote 4
		...
		model = glm::translate(modelTemp, glm::vec3(1.0f, 0.0f, 0.0f)); //pivote 5
		...
		model = glm::rotate(model, glm::radians(dedo1), glm::vec3(0.0f, 0.0, 1.0f));
		modelTemp = model = glm::translate(model, glm::vec3(0.65f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(1.3f, 0.3f, 0.25f));
		color = glm::vec3(0.0f, 1.0f, 1.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 0, 36);

		model = glm::translate(modelTemp, glm::vec3(0.65f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(dedo2), glm::vec3(0.0f, 0.0, 1.0f));
		model = glm::translate(model, glm::vec3(0.4f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(0.8f, 0.3f, 0.25f));
		color = glm::vec3(1.0f, 0.0f, 1.0f);
